...
import com.todo.dao.IMailService;
import com.todo.dao.IRedisRepository;
import com.todo.dao.IUserRepository;
...
import com.todo.model.LoginDTO;
import com.todo.model.Sequence;
...
public class UserServiceImpl implements IGeneralUserService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.todo.services.IGeneralUserService#doResetPassword(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.todo.services.IGeneralUserService#getNextSequence(java.lang.String)
	 */
	@Override
