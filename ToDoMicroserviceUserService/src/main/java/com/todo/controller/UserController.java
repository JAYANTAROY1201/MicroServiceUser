...
import com.todo.services.IGeneralUserService;
...
public class UserController {
	...
	public List<?> view()
		...
		return userService.doPrintAll();
	
//		logger.info("Vie all user invoked");
...
//		return new ResponseEntity<>(allUser, HttpStatus.OK);
	...
	public ResponseEntity<String> forgetPassword(@PathVariable String  email) throws LoginException, MessagingException {
